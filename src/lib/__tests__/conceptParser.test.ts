  ...
  describe("parseConceptsInText", () => {
    ...
    it("should identify multiple concepts in text", () => {
      ...
      const conceptTexts = concepts.map((c) =>
        c.type === "concept" ? c.displayText.toLowerCase() : ""
      );
    ...
    it("should match concept aliases to canonical terms", () => {
      ...
      const concept = result.find(
        (s) => s.type === "concept" && s.displayText.toLowerCase().includes("service")
      );
    ...
    it("should preserve word boundaries", () => {
      ...
      const loveLightConcept = result.find(
        (s) => s.type === "concept" && "displayText" in s && s.displayText.includes("/")
      );
    ...
    it("should match longer phrases before shorter ones", () => {
      ...
      const socialMemoryComplex = result.find(
        (s) => s.type === "concept" && s.displayText.toLowerCase().includes("social memory complex")
      );
    ...
    it("should handle punctuation after concepts", () => {
      ...
      const catalystConcept = result.find(
        (s) => s.type === "concept" && s.displayText.toLowerCase() === "catalyst"
      );
    ...
    it("should handle concepts with slashes", () => {
      ...
      const complexConcept = result.find(
        (s) => s.type === "concept" && s.displayText.includes("/")
      );
    ...
    it("should not match partial words", () => {
      ...
      const hasStandaloneLight = result.some(
        (s) => s.type === "concept" && s.displayText === "light"
      );
    ...
    it("should handle concepts with varying capitalization", () => {
      ...
      const logosConcept = result.find(
        (s) => s.type === "concept" && s.displayText.toLowerCase() === "logos"
      );
