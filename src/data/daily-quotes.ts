...
export const dailyQuotes: DailyQuote[] = [
  {
    ...
    text: {
      ...
      es: "No se está hablando de entidades o cosas similares o de cierto parecido. Eres todo, cada ser, cada emoción, cada suceso, cada situación. Eres unidad. Eres infinidad. Eres amor/luz, luz/amor.",
      de: "Ihr seid jedes Ding, jedes Wesen, jedes Gefühl, jedes Ereignis, jede Situation. Ihr seid Einheit. Ihr seid Unendlichkeit. Ihr seid Liebe/Licht, Licht/Liebe. Dies ist das Gesetz des Einen.",
    },
  },
  {
    reference: "Ra 1.7",
    text: {
      ...
      es: "Considera, si quieres, el carácter infinito del universo. Es algo que todavía ha de demostrarse o refutarse; pero podemos asegurarles que no existe un límite en ustedes, para tu comprensión, de lo que llamarías tu viaje de búsqueda o tus percepciones de la creación.",
      de: "Bedenkt, wenn ihr mögt, dass das Universum unendlich ist. Dies muss noch bewiesen oder widerlegt werden, aber wir können euch versichern, dass es für eure Selbste, eure Erkenntnis, für das, was ihr die Reise der Suche nennen würdet, oder für eure Vorstellungen der Schöpfung kein Ende gibt.",
    },
  },
  {
    reference: "Ra 4.20",
    text: {
      ...
      es: "No puedes hacer sugerencias, así que te preguntaré, ¿puedes exponer la Ley del Uno y las leyes de sanación?",
      de: "Dem Gesetz des Einen, obwohl jenseits der Begrenzungen von Benennung, wie ihr Klangschwingungskomplexe nennt, kann man sich durch die Aussage annähern, dass alle Dinge eins sind, dass es keine Polarität gibt, kein Richtig oder Falsch, keine Disharmonie, sondern nur Identität.",
    },
  },
  {
    reference: "Ra 1.7",
    text: {
      ...
      es: "En realidad, no existe lo correcto o lo erróneo. No existe polaridad, pues todo será, como dirías, conciliado en algún momento de tu danza a través del complejo mente/cuerpo/espíritu que gustas distorsionar de varios modos en el momento actual.",
      de: "In Wahrheit gibt es kein richtig oder falsch. Es gibt keine Polarität, da alles, wie ihr sagen würdet, irgendwann wieder miteinander versöhnt wird in eurem Tanz durch den Geist/Körper/Seele-Komplex, mit dem ihr euch momentan amüsiert, indem ihr ihn auf verschiedene Weise verzerrt.",
    },
  },
  {
    reference: "Ra 1.0",
    text: {
      ...
      es: "Son parte de un pensamiento. Están bailando en un salón en donde no hay materia. Ustedes son pensamientos danzantes.",
      de: "Und wurde Dienst frei gegeben?Ihr seid nicht Teil eines materiellen Universums. Ihr seid Teil eines Gedankens. Ihr tanzt in einem Ballsaal, in dem es nichts Materielles gibt.",
    },
  },
  {
    reference: "Ra 1.0",
    text: {
      ...
      es: "Esa declaración, mis amigos, como saben, es: «Todas las cosas, toda la vida, toda la creación es parte del Pensamiento Original Único».",
      de: "Das Bündnis der Planeten im Dienst des Unendlichen Schöpfers hat nur eine wichtige Botschaft.",
    },
  },
  {
    reference: "Ra 13.5",
    text: {
      ...
      es: "La infinidad es la creación.",
  ...
  },
  {
    ...
    text: {
      ...
      de: "Der Moment enthält Liebe. Das ist die Lektion/das Ziel dieser Illusion oder Dichte. Die Übung ist, diese Liebe bewusst in Bewusstseins- und Erkenntnisverzerrungen zu suchen.",
    },
  },
  {
    reference: "Ra 10.14",
    text: {
      ...
      es: "Mira la creación que se encuentra alrededor del complejo mente/cuerpo/espíritu de cada entidad. Ve al Creador.",
      de: "Sieh den Schöpfer. Die Grundlage oder Voraussetzung von diesen Übungen ist eine Vorliebe für das, was ihr Meditation, Kontemplation oder Gebet nennt.",
    },
  },
  {
    reference: "Ra 10.14",
    text: {
      ...
      de: "Doch der bewusste Ausdruck von Selbst zu Selbst des Wunsches, Liebe zu suchen, ist so ein zentraler Willensakt, dass, wie zuvor, der Verlust an Kraft durch diese Reibung folgenlos ist.Übung Zwei. Das Universum ist ein Wesen.",
    },
  },
  {
    reference: "Ra 17.30",
  ...
  },
  {
    ...
    text: {
      ...
      de: "Das Herz der Disziplin der Persönlichkeit ist dreifach. Eins, dich selbst zu erkennen. Zwei, dich selbst anzunehmen. Drei, der Schöpfer zu werden.",
    },
  },
  {
    reference: "Ra 8.1",
  ...
  },
  {
    ...
    text: {
      ...
      es: "Mientras tanto, el Creador yace dentro. En el polo norte, la corona ya está sobre la cabeza y la entidad es potencialmente un dios. Esta energía nace de la aceptación humilde y confiada a través de la meditación y la contemplación del yo y del Creador.",
      de: "Währenddessen liegt der Schöpfer im Inneren. Im Nordpol ist die Krone bereits auf dem Kopf und das Wesen ist potenziell ein Gott. Diese Energie wird durch Meditation und Kontemplation des Selbst und des Schöpfers von der demütigen und vertrauenden Akzeptanz dieser Energie in die Existenz gebracht.",
    },
  },
  {
    reference: "Ra 75.23",
  ...
  },
  {
    ...
    text: {
      ...
      de: "Es ist unmöglich, einem anderen Wesen direkt zu helfen. Es ist nur möglich, Auslöser in jeglicher Form zur Verfügung zu stellen, wobei das Wichtigste das Ausstrahlen von Realisierung von Einheit mit dem Schöpfer vom Selbst aus ist; weniger wichtig sind solche Informationen, wie wir sie mit euch teilen.",
    },
  },
  {
    reference: "Ra 89.30",
  ...
  },
  {
    ...
    text: {
      ...
      es: "La aceptación del yo, el perdón del yo y la dirección de la voluntad: este es el camino hacia la personalidad disciplinada.",
      de: "Akzeptanz des Selbst, Vergebung des Selbst und die Ausrichtung des Willens; dies ist der Pfad zur disziplinierten Persönlichkeit.",
    },
  },
  {
    reference: "Ra 42.9",
  ...
  },
  {
    ...
    text: {
      ...
      es: "El complejo mente/cuerpo/espíritu no es una máquina. Es más bien lo que podríamos llamar un poema tonal.",
      de: "Der Geist/Körper/Seele-Komplex ist keine Maschine. Es ist eher das, was du ein Tongedicht nennen könntest.",
    },
  },
  {
    reference: "Ra 34.2",
  ...
  },
  {
    ...
    text: {
      ...
      es: "No hay historia, como entendemos tu concepto. Imagínate, si quieres, un círculo de existencia. Conocemos el alfa y el omega como la inteligencia infinita.",
      de: "Es gibt keine Geschichte, wie wir euer Konzept verstehen. Stelle dir vor, wenn du magst, einen Kreis des Seins. Wir kennen das Alpha und Omega als unendliche Intelligenz.",
    },
  },
  {
    reference: "Ra 66.10",
    text: {
      ...
      es: "El sanador no sana. El sanador cristalizado es un canal para la energía inteligente la cual ofrece a la entidad la oportunidad de sanarse a sí misma.",
      de: "Der Heiler heilt nicht. Der kristallisierte Heiler ist ein Kanal für intelligente Energie, die einem Wesen eine Gelegenheit anbietet, damit es sich selbst heilen mag.",
    },
  },
  {
    reference: "Ra 66.12",
    text: {
      ...
      es: "Tal vez el mejor sanador se encuentre dentro del ser y puede ser derivado con la meditación continua, como lo hemos sugerido anteriormente.",
      de: "Vielleicht der größte Heiler liegt im Inneren des Selbst und kann mit fortgesetzter Meditation, wie wir vorgeschlagen haben, erschlossen werden.",
    },
  },
  {
    reference: "Ra 48.7",
    text: {
      ...
      es: "Lo importante para la cosecha es el equilibrio armonioso entre los diversos centros energéticos del complejo mente/cuerpo/espíritu.",
  ...
  },
  {
    ...
    text: {
      ...
      es: "No es necesario que los centros energéticos estén activados en orden en el caso de la entidad consciente de sí misma.",
  ...
  },
  {
    ...
    text: {
      ...
      es: "El libre albedrío es de la esencia.",
    },
  },
  {
    reference: "Ra 50.7",
    text: {
      ...
      es: "Este es el juego: conocer, aceptar, perdonar, equilibrar y abrir el yo en el amor.",
      de: "Dieses Spiel kann nur von jenen gewonnen werden, die ihre Karten im zerschmelzenden Einfluss der Liebe verlieren; kann nur von jenen gewonnen werden, die ihre Freuden, ihre Einschränkungen, ihr Alles mit der Bildseite nach oben auf den Tisch legen und innerlich sagen: „Ihr, all ihr Spieler, jedes Andere-Selbst, was auch immer deine Hand, ich liebe dich.“Das ist das Spiel: zu wissen, zu akzeptieren, zu vergeben, auszugleichen und das Selbst in Liebe zu öffnen.",
    },
  },
  {
    reference: "Ra 95.24",
    text: {
      ...
      es: "Sin embargo, para los puros, todo lo que se encuentra habla del amor y la luz del Creador Único Infinito.",
      de: "Zum Reinen spricht jedoch alles, dem begegnet wird, von der Liebe und dem Licht des Einen Unendlichen Schöpfers.",
    },
  },
  {
    reference: "Ra 48.10",
    text: {
      ...
      es: "Esto debe hacerse con sumo cuidado mientras se está en el cuerpo físico, ya que, como señalamos al hablar de los peligros de vincular los circuitos rojo/naranja/amarillo con los circuitos de color azul verdadero, el potencial de alteración del complejo mente/cuerpo/espíritu es mayor.",
      de: "Ein Wesen, das intelligente Unendlichkeit durchdringt, ist jedoch grundsätzlich in der Lage, das Universum mit uneingeschränkten Schritten zu durchwandern.",
    },
  },
  {
    reference: "Ra 65.12",
    text: {
      ...
      es: "¿Podría su planeta polarizarse hacia la armonía en un buen y fuerte momento de inspiración? Sí, amigos míos. No es probable; pero siempre es posible.",
      de: "Könnte euer Planet sich in einem feinen, starken Moment der Inspiration zu Harmonie polarisieren? Ja, meine Freunde. Es ist nicht wahrscheinlich, aber es ist immer möglich.",
    },
  },
  {
    reference: "Ra 83.17",
  ...
  },
  {
    ...
    text: {
      ...
      de: "Lass uns sagen, aus Mangel an einem stärker präzisen Adjektiv, dass dieser Logos eine Neigung zu Freundlichkeit hat.",
    },
  },
  {
    reference: "Ra 52.2",
    text: {
      ...
      es: "Para la entidad disciplinada, todas las cosas están abiertas y son libres. La disciplina que abre los universos abre también las puertas de la evolución.",
      de: "Für das disziplinierte Wesen sind alle Dinge offen und frei. Die Disziplin, die die Universen öffnet, öffnet auch die Tore zu Evolution.",
    },
  },
  {
    reference: "Ra 52.11",
    text: {
      ...
      es: "Unidad, amor, luz y alegría: este es el corazón de la evolución del espíritu.",
      de: "Einheit, Liebe, Licht und Freude; dies ist das Herz der Evolution der Seele.",
    },
  },
  {
    reference: "Ra 102.11",
  ...
  },
  {
    ...
    text: {
      ...
      es: "Así, es deseable que un complejo mente/cuerpo/espíritu sea consciente y escuche la voz de su catalizador experiencial, obteniendo de él lo que encarnó a obtener.",
      de: "Daher ist es wünschenswert, dass ein Geist/Körper/Seele-Komplex sich der Stimme seines erfahrungsbezogenen Katalysten bewusst ist und ihr lauscht, um das von ihr herauszubekommen, wofür er, um es herauszubekommen, inkarnierte.",
    },
  },
  {
    reference: "Ra 94.12",
  ...
  },
  {
    ...
    text: {
      ...
      es: "Las lecciones a aprender varían. Casi siempre estas lecciones incluyen la paciencia, la tolerancia y una habilidad para la gentileza.",
      de: "Die Lektionen, die es zu lernen gilt, variieren. Fast immer beinhalten die Lektionen Geduld, Toleranz und die Fähigkeit zur Berührung mit dem Licht.",
    },
  },
  {
    reference: "Ra 34.14",
    text: {
      ...
      es: "Esto puede verse como lo que llamarías una progresión traumática.",
      de: "Dies mag als das angesehen werden, was ihr eine traumatische Weiterentwicklung nennen würdet.",
    },
  },
  {
    reference: "Ra 32.14",
  ...
  },
  {
    ...
    text: {
      ...
      es: "Como sabes, los que sanan, enseñan y trabajan para el Creador de cualquier forma que pueda considerarse radiante y equilibrada son los que realizan actividades del rayo índigo.",
      de: "Wie ihr euch bewusst seid, sind jene Aktivitäten, die für den Schöpfer auf irgendeine Weise, die als strahlend und ausgeglichen angesehen werden kann, heilen, lehren und arbeiten, die des Indigo-Strahls.",
    },
  },
  {
    reference: "Ra 15.14",
  ...
  },
  {
    ...
    text: {
      ...
      es: "En cada parte infinitesimal de tu ser reside el Uno en todo su poder.",
      de: "In jedem unendlich kleinen Teil eures Selbst wohnt das Eine in all Seiner Kraft.",
    },
  },
  {
    reference: "Ra 15.14",
    text: {
      ...
      es: "Sin este método de revertir el proceso analítico no podrían integrarse en la unidad las numerosas comprensiones obtenidas en dicha búsqueda.",
  ...
  },
  {
    ...
    text: {
      ...
      de: "Der Zweck der Klärung jedes Energiezentrums ist es, diesem Treffpunkt zu erlauben, an der Indigo-Strahl-Schwingung zu geschehen und so den Kontakt mit intelligenter Unendlichkeit herzustellen und alle Illusionen aufzulösen.",
    },
  },
  {
    reference: "Ra 15.9",
  ...
  },
  {
    ...
    text: {
      ...
      es: "La Ley del Uno se mantiene imperturbable ante la luz y ante la oscuridad, está disponible para el servicio a otros y para el servicio al yo.",
      de: "Das Gesetz des Einen zwinkert weder mit dem Licht noch mit der Dunkelheit, sondern steht für Dienst an Anderen und Dienst am Selbst zur Verfügung.",
    },
  },
  {
    reference: "Ra 30.5",
    text: {
      ...
      es: "Este complejo mente/cuerpo descubre entonces en segunda densidad el crecimiento y el giro hacia la luz, despertando así lo que podrías llamar el complejo espiritual, aquello que intensifica la espiral ascendente hacia el amor y la luz del Creador Infinito.",
      de: "Dieser Geist/Körper-Komplex entdeckt dann in zweiter Dichte das Wachsen und die Hinwendung zum Licht, wodurch das erwacht, was du den spirituellen Komplex nennen kannst, der die spiralförmige Aufwärtsbewegung zur Liebe und zum Licht des Unendlichen Schöpfers verstärkt.",
    },
  },
  {
    reference: "Ra 82.12",
    text: {
      ...
      es: "La creación misma es una forma de consciencia unificada—siendo el Logos el gran corazón único de la creación.",
      de: "Die Schöpfung selbst ist eine Form von Bewusstsein, welches vereinigt ist, während der Logos das eine große Herz von Schöpfung ist.",
    },
  },
  {
    reference: "Ra 82.17",
    text: {
      ...
      es: "El Creador aprenderá de sí mismo. Cada entidad tiene porciones no manifiestas de aprendizaje y, lo que es más importante, aprendizaje que está relacionado con otros-yo.",
      de: "Der Schöpfer will von Sich selbst lernen. Jedes Wesen hat nicht-manifestierte Anteile des Lernens und, höchst wichtig, Lernen, welches mit Anderen-Selbsten in Verbindung steht.",
    },
  },
  {
    reference: "Ra 50.9",
  ...
  },
  {
    ...
    text: {
      ...
      es: "Podemos observar que las características de las que hablas tienen relación con el Significante del complejo de la Mente, pero no son el centro.",
      de: "Wir können anmerken, dass die Eigenschaften, von denen du sprichst, Einfluss auf den Signifikator des Geist-Komplexes haben, aber nicht der Kern sind.",
    },
  },
  {
    reference: "Ra 5.2",
    text: {
      ...
      es: "El requisito previo del trabajo mental es la capacidad de retener el silencio del yo en un estado constante cuando lo requiera el yo. La mente debe estar abierta como una puerta. La clave es el silencio.",
      de: "Die Voraussetzung von geistiger Arbeit ist die Fähigkeit, Stille des Selbst in einem stetigen Zustand zu bewahren, wenn vom Selbst benötigt. Der Geist muss geöffnet sein wie eine Tür. Der Schlüssel ist Stille.",
    },
  },
  {
    reference: "Ra 52.11",
    text: {
      ...
      es: "Este es el gran aprendizaje/enseñanza. En esta unidad está el amor. Este es un gran aprendizaje/enseñanza. En esta unidad está la luz. Esta es la enseñanza fundamental de todos los planos de existencia en la materialización.",
      de: "Lasst uns daran erinnern, dass wir alle eins sind. Dies ist das große Lern/Lehren. In dieser Einheit liegt Liebe. Dies ist ein großes Lern/Lehren. In dieser Einheit liegt Licht.",
    },
  },
  {
    reference: "Ra 42.9",
  ...
  },
  {
    ...
    text: {
      ...
      es: "El centro energético violeta es el menos variable y a veces se describe en tu filosofía como de mil pétalos, ya que es la suma de la totalidad de la distorsión del complejo mente/cuerpo/espíritu.",
      de: "Das violette Energiezentrum ist das am wenigsten veränderliche und wird manchmal in eurer Philosophie als tausend-blättrig beschrieben, da es die Summe der Geist/Körper/Seele-Komplex-Verzerrungs-Totalität ist.",
    },
  },
  {
    reference: "Ra 52.12",
  ...
  },
  {
    ...
    text: {
      ...
      es: "Existe la unidad. Esta unidad es todo lo que hay. Esta unidad tiene un potencial y una cinética. El potencial es infinidad inteligente. Aprovechar este potencial producirá trabajo. Este trabajo ha sido llamado por nosotros, energía inteligente.",
      de: "Es gibt Einheit. Diese Einheit ist alles, was ist. Diese Einheit besitzt Potenzial und Kinetik. Das Potenzial ist intelligente Unendlichkeit. Dieses Potenzial zu erschließen erzeugt Arbeit. Diese Arbeit wurde von uns intelligente Energie genannt.",
    },
  },
  {
    reference: "Ra 81.23",
  ...
  },
  {
    ...
    text: {
      ...
      es: "La voluntad de la entidad, a medida que evoluciona, es la única medida de la velocidad y minuciosidad de la activación y el equilibrio de los diversos centros energéticos.",
      de: "Der Wille des Wesens ist das einzige Maß des Grades und der Sorgfältigkeit der Aktivierung und des Ausgleichens der verschiedenen Energiezentren.",
    },
  },
  {
    reference: "Ra 41.22",
  ...
  },
  {
    ...
    text: {
      ...
      es: "Conocerse a sí mismo es tener la base sobre terreno firme.",
    },
  },
  {
    reference: "Ra 52.11",
  ...
  },
  {
    ...
    text: {
      ...
      es: "Incluso la más infeliz de las experiencias, digamos, que parece ocurrir en el Catalizador del adepto, vista desde el punto de vista del espíritu, puede, con la discriminación posible en la sombra, ser trabajada hasta que la luz iguale la luz del mediodía más brillante, descienda sobre el adepto y se produzca una iluminación positiva o de servicio a otros.",
      de: "Selbst mit den unglücklichsten Erfahrungen, sagen wir, die im Katalyst des Adepten zu geschehen scheinen, kann, vom Standpunkt der Seele aus gesehen, mit der Unterscheidung, die in Schatten möglich ist, gearbeitet werden, bis Licht, das dem Licht des hellsten Mittags gleicht, auf den Adepten hernieder kommt und positive oder Dienst-an-Anderen-Erleuchtung geschehen ist.",
    },
  },
  {
    reference: "Ra 54.17",
    text: {
      ...
      es: "Cuanto más avanzada es la entidad, más tenue es la conexión entre el sub-logos y el catalizador percibido hasta que, finalmente, todo el catalizador es elegido, generado y fabricado por el yo, para el yo.",
      de: "Je fortgeschrittener das Wesen, desto schwächer die Verbindung zwischen dem Sub-Logos und dem wahrgenommenen Katalyst, bis letztendlich aller Katalyst vom Selbst gewählt, erzeugt und hergestellt wird, für das Selbst.",
    },
  },
  {
    reference: "Ra 80.20",
    text: {
      ...
      es: "La infinidad del espíritu es una realización aún mayor que la infinidad de la consciencia, porque la consciencia que ha sido disciplinada por la voluntad y la fe es la consciencia que puede contactar directamente con la infinidad inteligente.",
      de: "Die Unendlichkeit der Seele ist sogar eine noch größere Verwirklichung als die Unendlichkeit von Bewusstsein, denn Bewusstsein, das durch Willen und Glauben diszipliniert wurde, ist das Bewusstsein, das direkt intelligente Unendlichkeit kontaktieren kann.",
    },
  },
  {
    reference: "Ra 6.1",
    text: {
      ...
      de: "Die Erforschung und Ausbalancierung des Seele-Komplexes ist in der Tat der längste und feinstofflichste Teil eures Lern/Lehrens.",
    },
  },
  {
    reference: "Ra 6.1",
    text: {
      ...
      es: "Cuando el cuerpo y la mente están receptivos y abiertos, entonces el espíritu puede convertirse en una lanzadera en funcionamiento, o comunicador, desde la energía de la voluntad individual de la entidad hacia arriba y desde las corrientes del fuego y el viento creativos hacia abajo.",
      de: "Wenn Körper und Geist empfänglich und offen sind, dann kann die Seele ein funktionierendes Shuttle oder Sprecher, von der individuellen Willensenergie des Wesens aufwärts und von den Strömungen des schöpferischen Feuers und Windes abwärts, werden.",
    },
  },
  {
    reference: "Ra 80.14",
    text: {
      ...
      de: "Es wäre passender, zu sagen, dass der Adept direkt durch die Seele zum Universum nach seiner Kraft ruft, denn die Seele ist ein Shuttle.",
    },
  },
  {
    reference: "Ra 79.33",
  ...
  },
  {
    ...
    text: {
      ...
      es: "Dejo este instrumento en el amor y la luz del Creador Único Infinito. Vayan, por lo tanto, regocijándose en el poder y la paz del Creador Único. Descrito anteriormente en #9.6–1.",
      de: "Geht fort, deshalb, und erfreut euch in der Kraft und im Frieden des Einen Schöpfers. Einsetzung, Einkleidung. ↩Bereits beschrieben in #9.6.",
    },
  },
  {
    reference: "Ra 26.36",
    text: {
      ...
      es: "En un sentido más profundo, el ser no tiene fin.",
      de: "Jedes Lebewesen ist nur oberflächlich das, was blüht und stirbt. In einem tieferen Sinn gibt es kein Ende des Seins.",
    },
  },
  {
    reference: "Ra 19.17",
  ...
  },
  {
    ...
    text: {
      ...
      es: "Nosotros también somos actores en un escenario. El escenario cambia. Los actos se apagan. Las luces vuelven a encenderse. Y a lo largo de la gran ilusión, y lo que sigue, y lo que sigue, está la majestuosidad subyacente del Creador Único Infinito. Todo está bien. Nada se ha perdido.",
      de: "Wir sind auch Spieler auf einer Bühne. Die Bühne verändert sich. Die Akte klingeln herunter. Die Lichter kommen wieder hoch. Und überall in der großen Illusion und der nächsten und der nächsten gibt es die untermauernde Erhabenheit des Einen Unendlichen Schöpfers. Alles ist gut. Nichts ist verloren.",
    },
  },
  {
    reference: "Ra 33.21",
    text: {
      ...
      es: "Adonai.1 de marzo de",
      de: "Original blending, auch Mischung, Vermischung.",
    },
  },
  {
    reference: "Ra 23.10",
    text: {
      ...
      es: "Nuestra dificultad reside en el honor/responsabilidad de corregir las distorsiones de la Ley del Uno que se produjeron durante nuestros intentos de ayudar a estas entidades.",
      de: "Wenn einer von dieser Sorge gerettet wurde, zu einer Vision des Einen Schöpfers, dann gibt es kein Konzept des Scheiterns.",
    },
  },
  {
    reference: "Ra 23.10",
    text: {
      ...
      es: "Las distorsiones son vistas como responsabilidades más que como fracasos; los pocos que fueron inspirados a buscar, nuestra única razón para el intento.",
      de: "Die Verzerrungen werden eher als Verantwortlichkeiten gesehen denn als Fehler; die Wenigen, die inspiriert waren, zu suchen, waren der einzige Grund für diesen Versuch.",
    },
  },
  {
    reference: "Ra 23.10",
