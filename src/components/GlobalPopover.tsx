        ...
        <span className="concept-popover-content">
          ...
          {relatedConcepts.length > 0 && (
            <span className="concept-popover-related">
              <span className="concept-popover-related-label">{tConcept("related")}</span>
          ...
          {keySessions.length > 0 && (
            <span className="concept-popover-sessions">
              <span className="concept-popover-sessions-label">{tConcept("keySessions")}</span>
