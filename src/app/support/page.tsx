      ...
      <div className="flex-1 overflow-auto relative z-10 py-12 px-6">
        <article className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-[var(--lo1-indigo)]/40 backdrop-blur-sm border border-[var(--lo1-celestial)]/40 rounded-2xl p-6 hover:border-[var(--lo1-gold)]/40 hover:shadow-[0_0_30px_rgba(212,168,83,0.1)] transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-[var(--lo1-starlight)]">Ask a Question</h3>
                </div>
              ...
              <div className="bg-[var(--lo1-indigo)]/40 backdrop-blur-sm border border-[var(--lo1-celestial)]/40 rounded-2xl p-6 hover:border-[var(--lo1-gold)]/40 hover:shadow-[0_0_30px_rgba(212,168,83,0.1)] transition-all duration-300">
                ...
                <p className="text-[var(--lo1-stardust)] text-sm leading-relaxed">
                  Your question is converted into a mathematical representation and compared against all ~1,500 Q&A pairs from the 106 sessions.
                </p>
              </div>
              ...
              <div className="bg-[var(--lo1-indigo)]/40 backdrop-blur-sm border border-[var(--lo1-celestial)]/40 rounded-2xl p-6 hover:border-[var(--lo1-gold)]/40 hover:shadow-[0_0_30px_rgba(212,168,83,0.1)] transition-all duration-300">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-[var(--lo1-starlight)]">Get Response</h3>
                </div>
          ...
          <section className="mb-16">
            ...
            <div className="bg-[var(--lo1-indigo)]/20 border border-[var(--lo1-celestial)]/30 rounded-2xl p-8">
              <p className="text-[var(--lo1-stardust)] leading-relaxed mb-4">
                The Ra Material, also known as <em className="text-[var(--lo1-starlight)]">The Law of One</em>, was channeled between 1981 and 1984 through Carla Rueckert by the social memory complex Ra. The sessions were facilitated by Don Elkins (questioner) and Jim McCarty (scribe).
              </p>
              <p className="text-[var(--lo1-stardust)] leading-relaxed mb-6">
                <strong className="text-[var(--lo1-starlight)]">L/L Research</strong> is the nonprofit organization that originally published the Ra Material and continues to steward these teachings. Founded by Don Elkins, Carla Rueckert, and Jim McCarty, L/L Research has dedicated itself to making the Law of One freely available to seekers worldwide.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="text-[var(--lo1-starlight)] font-medium group-hover:text-[var(--lo1-gold)] transition-colors">llresearch.org</div>
                    <div className="text-xs text-[var(--lo1-stardust)]">Official L/L Research website</div>
                  </div>
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="text-[var(--lo1-starlight)] font-medium group-hover:text-[var(--lo1-gold)] transition-colors">lawofone.info</div>
                    <div className="text-xs text-[var(--lo1-stardust)]">Searchable archive (our source)</div>
                  </div>
                  <svg className="w-4 h-4 text-[var(--lo1-gold)] opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
          ...
          <section className="mb-16">
            ...
            <div className="text-[var(--lo1-stardust)] space-y-4">
              ...
              <div className="bg-[var(--lo1-indigo)]/20 border border-[var(--lo1-celestial)]/30 rounded-xl p-6">
                <p className="text-sm text-[var(--lo1-starlight)] mb-3">According to L/L Research's copyright guidelines:</p>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>The material may be freely quoted for personal, educational, and non-commercial purposes</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-[var(--lo1-gold)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          ...
          <section className="mb-16">
            ...
            <div className="bg-[var(--lo1-indigo)]/20 border border-[var(--lo1-celestial)]/30 rounded-2xl p-8">
              <p className="text-[var(--lo1-stardust)] leading-relaxed mb-6">
                The Law of One Study Companion is an independent, open-source project created to help students of the Ra Material explore and understand the teachings more easily.
              </p>
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="text-[var(--lo1-starlight)] font-medium">Free and open source</div>
                    <div className="text-sm text-[var(--lo1-stardust)]">Code publicly available on GitHub</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[var(--lo1-gold)] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-[var(--lo1-stardust)]">Built with love for seekers</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[var(--lo1-gold)] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <div className="text-[var(--lo1-starlight)] font-medium">Independent project</div>
                    <div className="text-sm text-[var(--lo1-stardust)]">Not affiliated with L/L Research</div>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-[var(--lo1-gold)] flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <div className="text-[var(--lo1-starlight)] font-medium">Continuously improving</div>
                    <div className="text-sm text-[var(--lo1-stardust)]">Feedback and contributions welcome</div>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-16">
            ...
            <div className="bg-[var(--lo1-indigo)]/20 border border-[var(--lo1-celestial)]/30 rounded-xl p-6">
              <p className="text-[var(--lo1-stardust)] text-sm mb-4">For those interested in the technical implementation:</p>
              <div className="grid sm:grid-cols-2 gap-3 text-sm">
                ...
                <div className="flex items-center gap-3 p-3 bg-[var(--lo1-indigo)]/30 rounded-lg">
                  ...
                  <span className="text-[var(--lo1-starlight)] font-medium">text-embedding-3-small</span>
                </div>
                <div className="flex items-center gap-3 p-3 bg-[var(--lo1-indigo)]/30 rounded-lg">
          ...
          <section className="mb-16">
            <div className="bg-gradient-to-br from-[var(--lo1-indigo)]/60 to-[var(--lo1-indigo)]/40 border-2 border-[var(--lo1-gold)]/40 rounded-2xl p-8 shadow-[0_0_40px_rgba(212,168,83,0.15)]">
              ...
              <div className="space-y-4 text-[var(--lo1-starlight)]">
                <p className="leading-relaxed">
                  <strong className="text-[var(--lo1-gold)]">This tool is far from a primary study of the Ra Material and should only be used to supplement your study or for curiosity.</strong> It is not a replacement for reading the original sessions directly.
                </p>
                ...
                <p className="leading-relaxed text-sm border-t border-[var(--lo1-gold)]/20 pt-4">
                  <strong>Always verify important information</strong> by consulting the original Ra Material at{' '}
                  <a href="https://www.lawofone.info" target="_blank" rel="noopener noreferrer" className="text-[var(--lo1-gold)] hover:underline">
                    lawofone.info
                  </a>{' '}
                  or in the published books available from{' '}
                  <a href="https://www.llresearch.org" target="_blank" rel="noopener noreferrer" className="text-[var(--lo1-gold)] hover:underline">
                    L/L Research
                  </a>. For serious study of the Law of One, there is no substitute for reading the primary source material.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="bg-[var(--lo1-indigo)]/20 border border-[var(--lo1-celestial)]/30 rounded-xl p-6">
              <p className="text-[var(--lo1-stardust)] leading-relaxed mb-4">
                This tool is continuously evolving based on user feedback. If you encounter issues, have suggestions, or want to contribute:
              </p>
              <a
                href="https://github.com/Corrob/law-of-one-study"
                target="_blank"
