    ...
    <main className="min-h-dvh flex flex-col cosmic-bg relative">
      ...
      <div className="flex-1 overflow-auto relative z-10 py-8 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="h-5 w-80 bg-[var(--lo1-celestial)]/20 rounded animate-pulse mx-auto mb-8" />
          <div className="h-24 w-full max-w-lg bg-[var(--lo1-celestial)]/20 rounded-xl animate-pulse mx-auto" />
        </div>
      </div>
    </main>
  );
